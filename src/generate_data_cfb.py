...
@fyi
@dataframe_cacher(filename="data/event_data_cfb.parquet")
def get_event_data():
    return df_from_oracle("queries/event_data_cfb.sql")


@fyi
@dataframe_cacher(filename="data/odds_data_cfb.parquet")
def get_odds_data():
    return df_from_oracle("queries/odds_data_cfb.sql")


@fyi
@dataframe_cacher(filename="data/game_data_cfb.parquet")
def get_game_data():
    return df_from_oracle("queries/game_data_cfb.sql")


@fyi
@dataframe_cacher(filename="data/schedule_data_cfb.parquet")
def get_schedule_data():
    return df_from_oracle("queries/schedule_data_cfb.sql")


@fyi
@dataframe_cacher(filename="data/division_data_cfb.parquet")
def get_division_data():
    return df_from_oracle("queries/division_data_cfb.sql")
